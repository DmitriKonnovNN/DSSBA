...
public class UserControllerValidatorAspect {
    ...
    public UserControllerValidatorAspect(@Value("${userService.maxTokenExpirationTime.min}") int minutes,
                                         @Value("${userService.maxTokenExpirationTime.hours}") int hours,
                                         @Value("${userService.maxTokenExpirationTime.days}") int days) {
