...
import io.dmitrikonnov.DeanerySimpleSpringBootApp.configuration.SecurityConfig.securityConfigUtils.SecurityConfigWebAdapterQualifierResolver;
...
public class ApplicationSecurityMainConfig {
    ...
    public ApplicationSecurityMainConfig(@Autowired SecurityConfigWebAdapterQualifierResolver resolver,
                                         @Value("${appSecurity.webSecurityAdapterQualifier}") String qualifier) {
